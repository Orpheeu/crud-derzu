...
public:
    ...
    Cliente(int _idCliente, std::string _nomeCliente, std::string _cpf) {
    ...
    // metodos para controlar o contador estático ao salvar/carregar
    static int getNumClientes() { return numClientes; }
    static void setNumClientes(int num) { numClientes = num; }
};